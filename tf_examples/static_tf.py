...
class FramePublisher(Node):
    ...
    def __init__(self):
        ...
        t3.child_frame_id = 'caster'
        t3.transform.translation.x = -0.095
        t3.transform.translation.y = 0.0
        t3.transform.translation.z = -0.03
        q3 = transforms3d.euler.euler2quat(0,0,0)   #input euler2quat(roll, pitch, yaw) , output q=[w, x, y, z] 
        ...
        self.static_br3.sendTransform(t3)
