...
package_name = 'reto_final_final_sim'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'puzzlebot_gazebo = reto_final_final_sim.puzzlebot_gazebo:main',
            'aruco = reto_final_final_sim.aruco:main',
            'odom = reto_final_final_sim.odom:main',
            'puzzlebot_bot = reto_final_final_sim.puzzle_bot:main',
            'puzzlebot_sim = reto_final_final_sim.puzzlebot_sim:main'
        ],
    },
)
